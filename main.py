...
# print("certA: " + str(certA) + str(type(certA)))
certB = bob.generateCertificate()
# print("certB: " + str(certB) + str(type(certB)))
certC = carol.generateCertificate()
# print("certC: " + str(certC) + str(type(certC)))
...
# #my own test
# header, ct = bob.sendMessage("alice", "Hi again Bob!")
# msg = alice.receiveMessage("bob", header, ct)
# if msg != "Hi again Bob!":
#     error("test failed")
# else:
#     print("nigga you pasesd and fuck this class")
